...
Five views:
  ...
  5. Methodology & Sources         — every coefficient, citation, and caveat
...
st.sidebar.caption("True Cost Accounting for agrifood systems · aligned to FAO SOFA 2024")
...
audited `tca` engine (22 passing unit tests), and every coefficient is shown below with
